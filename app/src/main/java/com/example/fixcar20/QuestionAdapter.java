...
public class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.QuestionHolder>{
    ...
    static class QuestionHolder extends RecyclerView.ViewHolder {
        ...
        public QuestionHolder(@NonNull View itemView) {
            ...
            //              if (answer1.getText().equals(list.get(getAdapterPosition()).getAnswerRight())){
...
//
            ...
            //          @Override
            //          public void onClick(View v) {
            //              if (answer2.getText().equals(list.get(getAdapterPosition()).getAnswerRight())){
            //                  MotionToast.Companion.createColorToast((Activity) context,
            //                          "Ответ правелен!",
            //                          "Молодец!",
            //                          MotionToastStyle.SUCCESS,
...
//
            ...
            //          @Override
            //          public void onClick(View v) {
            //              if (answer3.getText().equals(list.get(getAdapterPosition()).getAnswerRight())){
            //                  MotionToast.Companion.createColorToast((Activity) context,
            //                          "Ответ правелен!",
            //                          "Молодец!",
            //                          MotionToastStyle.SUCCESS,
...
//
            ...
            //          @Override
            //          public void onClick(View v) {
            //              if (answer4.getText().equals(list.get(getAdapterPosition()).getAnswerRight())){
            //                  MotionToast.Companion.createColorToast((Activity) context,
            //                          "Ответ правелен!",
            //                          "Молодец!",
            //                          MotionToastStyle.SUCCESS,
